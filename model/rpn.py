...
class SiameseRPN:
    ...
    def build_model(self, template_shape: tuple = (127, 127, 3),
                    detection_shape: tuple = (255, 255, 3)) -> Model:
        ...
        detection_feature = Conv2D(256, kernel_size=3, name='RPN_Detection_Conv1')(self.feature_extraction(detection))
        ...
        # One Shot Detection
        cls_output = SiameseConv('cls')([detection_feature, template_cls_feature])
        reg_output = SiameseConv('reg')([detection_feature, template_reg_feature])
